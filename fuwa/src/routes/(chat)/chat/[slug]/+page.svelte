<script>
	...
	const sendMessage = () => {
		...
		// add to doc using the primitive date as key and also the message as given below
		let new_message = {};
...
<div class="wrap">
	...
	<div class="p-4 relative mt-[-80vh] overflow-scroll h-[78vh] scroll-smooth" id="message-list">
